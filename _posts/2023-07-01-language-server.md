...
- [pkgbuild-language-server](https://github.com/Freed-Wu/pkgbuild-language-server): ArchLinux/Windows Msys2 `PKGBUILD`
- [portage-language-server](https://github.com/Freed-Wu/portage-language-server): Gentoo portage `ebuild` 。笔者应该今后都不会用 Gentoo 了 :smile:
- [termux-language-server](https://github.com/Freed-Wu/termux-language-server): Android termux `build.sh`
- [autoconf-language-server](https://github.com/Freed-Wu/autoconf-language-server): GNU autoconf 。 嗯，不过笔者已经决定以后都用 CMake 了。 CMake 用户可以用 [cmake-language-server](https://github.com/regen100/cmake-language-server)。
